...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Forever 4 Beauty Care- Spa Website Template</title>
                ...
                <div class="container px-0">
                    <nav class="navbar navbar-light navbar-expand-xl">
                        <a href="index.html" class="navbar-brand">
                            <h1 class="text-primary display-4">Forever 4 Beauty Care</h1>
                        </a>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="team-item">
                            ...
                            <div class="team-text rounded-bottom text-center p-4">
                                <h3 class="text-white">Dhanashri Girase</h3>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="team-item">
                            ...
                            <div class="team-text rounded-bottom text-center p-4">
                                <h3 class="text-white">Prerna Dhakare</h3>
                                <p class="mb-0 text-white">Spa & Beauty Expert</p>
                            </div>
                            <div class="team-social">
                                <a class="btn btn-light btn-light-outline-0 btn-square rounded-circle mb-2" href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="team-item">
                            ...
                            <div class="team-text rounded-bottom text-center p-4">
                                <h3 class="text-white">Rohini Ghogare</h3>
                                <p class="mb-0 text-white">Spa & Beauty Expert</p>
                            </div>
                            <div class="team-social">
                                <a class="btn btn-light btn-light-outline-0 btn-square rounded-circle mb-2" href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="team-item">
                            ...
                            <div class="team-text rounded-bottom text-center p-4">
                                <h3 class="text-white">Ragini Gangurde</h3>
                                <p class="mb-0 text-white">Spa & Beauty Expert</p>
                            </div>
                            <div class="team-social">
                                <a class="btn btn-light btn-light-outline-0 btn-square rounded-circle mb-2" href="#"><i class="fab fa-twitter"></i></a>
